    ...
    <div className="bg-white rounded-2xl p-5 border border-[#EAE4D5] shadow-xs flex flex-col justify-between">
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-start gap-3.5">
          <div className="p-2.5 rounded-2xl bg-[#E8F5E9] text-[#2E7D32] shrink-0 mt-0.5">
          ...
          <div>
            ...
            <div className="text-xl font-extrabold text-[#0C2518] mt-0.5">
              {statusText}
            </div>
            <div className="text-[10px] text-[#8D6E63] mt-0.5">
              Based on latest observation <span className="font-semibold text-[#2E7D32]">(POC demo analysis)</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative w-20 h-20 shrink-0 flex items-center justify-center">
          ...
          <span className="absolute text-sm font-extrabold font-mono text-[#0C2518]">
            {score}%
          </span>
        </div>
      </div>
